import type {
  NextApiHandler as NAH,
  NextApiRequest as NARQ,
  NextApiResponse as NARS,
} from "next";
import type { AnyZodObject as ZO, infer as INF } from "zod";
export type { AnyZodObject as ZO, infer as INF } from "zod";

export type CreateContext<C extends INF<ZO>> = (
  req: NARQ,
  res: NARS
) => C | Promise<C>;
...
export type Client<I extends ZO, O extends ZO> = (
  input: INF<I>
) => Promise<INF<O>>;
...
export type ClientMap<I extends ZO, O extends ZO> = Map<
  Method,
  ClientWrapper<I, O>
>;
...
export type HandlerMap<C extends ZO, I extends ZO, O extends ZO> = Map<
  Method,
  HandlerWrapper<C, I, O>
>;
